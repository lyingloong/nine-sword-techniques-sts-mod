...
import ninesword.actions.GainEnergyIfFatalAction;
import ninesword.cards.SwordTechniqueCard;
import ninesword.powers.GhostlySwordPower;

public class SoulControlTrickery extends SwordTechniqueCard {
    public static final String ID = "NineSwordTechniques:SoulControlTrickery";
    ...
    protected void repeatEffect(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new GhostlySwordPower(p, 3), 3));
        addToBot(new GainEnergyIfFatalAction(m, 1));
    }
